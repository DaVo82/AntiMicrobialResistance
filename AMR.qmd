...
amr_data %>% 
  ...
  mutate(
    dalys_Number_UC = paste("(", as.character(dalys_lower_Number), ", ",
                            as.character(dalys_upper_Number), ")", sep = ""),
    dalys_Rate_UC = paste("(", as.character(dalys_lower_Rate), ", ",
                          as.character(dalys_upper_Rate), ")", sep = ""),
    deaths_Number_UC = paste("(", as.character(deaths_lower_Number), ", ",
                             as.character(deaths_upper_Number), ")", sep = ""),
    deaths_Rate_UC = paste("(", as.character(deaths_lower_Rate), ", ",
                           as.character(deaths_upper_Rate), ")", sep = ""),
    ylds_Number_UC = paste("(", as.character(ylds_lower_Number), ", ",
                           as.character(ylds_upper_Number), ")", sep = ""),
    ylds_Rate_UC = paste("(", as.character(ylds_lower_Rate), ", ",
                         as.character(ylds_upper_Rate), ")", sep = ""),
    ylls_Number_UC = paste("(", as.character(ylls_lower_Number), ", ",
                           as.character(ylls_upper_Number), ")", sep = ""),
    ylls_Rate_UC = paste("(", as.character(ylls_lower_Rate), ", ",
                         as.character(ylls_upper_Rate), ")", sep = ""),
